"""
Django settings for school_adm project.
...
SECRET_KEY = 'django-insecure-i3rn2iw3@k($yn-$lzgxpt$jyn(c%u6hb6u1n)6_ye@crbhx7c'
...
WSGI_APPLICATION = 'school_adm.wsgi.application'
